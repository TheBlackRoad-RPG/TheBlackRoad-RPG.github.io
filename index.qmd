...
| regalia for the first time once you hit Lvl 45 or higher |
| with *at least* one Essence.                             |
+----------------------------------------------------------+
...
+------------------------+------------------------+
| **Battleforge          | **Divine Regalia**     |
| Regalia**              |                        |
|                        | -   Strength: 20 → 70  |
| -   Strength: 25 → 75  | -   Intelligence: 15 → |
| -   Agility: 10 → 60   |     65                 |
| -   Attack Damage: 15  | -   Mana: 75 → 825     |
|     → 115              | -   Spell Power: 75 →  |
| -   Armor: 10 → 80     |     825                |
| -   Evasion I →        | -   Armor: 5 → 35      |
|     Evasion V          | -   Resist: 5 → 35     |
+------------------------+------------------------+
| **Wild Regalia**       | **Ironwood Regalia**   |
|                        |                        |
| -   Agility: 5 → 55    | -   Agility: 25 → 75   |
| -   Intelligence: 30 → | -   Intelligence: 10 → |
|     80                 |     60                 |
| -   Health: 100 → 1100 | -   Mana: 75 → 825     |
| -   Mana: 100 → 1100   | -   Spell Power: 75 →  |
| -   Spell Power: 100 → |     825                |
|     1100               | -   Attack Damage: 25  |
|                        |     → 175              |
+------------------------+------------------------+
...
|                        |                        |
| -   Intelligence: 35 → | -   Strength: 5 → 55   |
|     135                | -   Intelligence: 30 → |
| -   Flat Health Regen: |     80                 |
|     1 → 17.5           | -   Spell Damage: 50 → |
| -   Spell Damage: 125  |     750                |
|     → 1375             | -   Spell Healing: 150 |
|                        |     → 2250             |
|                        | -   Mana Regeneration  |
|                        |     I → Mana           |
|                        |     Regeneration XI    |
...
|                        |                        |
| -   Intelligence: 35 → | -   Strength: 15 → 65  |
|     135                | -   Intelligence: 5 →  |
| -   Health: 50 → 1000  |     55                 |
| -   Mana: 100 → 1500   | -   Health: 150 → 1500 |
| -   Spell Damage: 125  | -   Mana: 150 → 1500   |
|     → 1375             | -   Spell Damage: 50 → |
| -   Mana Regeneration  |     550                |
|     I → Mana           | -   Armor: 5 → 35      |
|     Regeneration XI    | -   Resist: 25 → 125   |
+------------------------+------------------------+
| **Veteran's Regalia**  | **Deathbringer         |
|                        | Regalia**              |
| -   Strength: 15 → 65  |                        |
| -   Intelligence: 5 →  | -   Strength: 5 → 55   |
|     55                 | -   Agility: 30 → 80   |
| -   Health: 150 → 1500 | -   Health: 150 → 1500 |
| -   Mana: 150 → 1500   | -   Attack Damage: 30  |
| -   Spell Power: 50 →  |     → 300              |
|     400                | -   Bloodthirsty       |
| -   Armor: 10 → 60     | -   Critical Strike    |
|                        |     2.5                |
|                        | -   Deathbringer       |
|                        |     Set---Base attack  |
|                        |     speed set to 1.6   |
