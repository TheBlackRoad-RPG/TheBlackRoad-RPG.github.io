...
-   Rewrote the description to state how much mana is drained per
    second, in addition to clarifying that the bonuses and movement
...
| -   Agility: 10 → 60    | -   Intelligence: 15 →  |
| -   Attack Damage: 15 → |     65                  |
|     115                 | -   Mana: 75 → 825      |
| -   Armor: 10 → 80      | -   Spell Power: 75 →   |
| -   Evasion I → Evasion |     825                 |
|     V                   | -   Armor: 5 → 35       |
|                         | -   Resist: 5 → 35      |
+-------------------------+-------------------------+
...
| -   Mana Regeneration I |     550                 |
|     → Mana Regeneration | -   Armor: 5 → 35       |
|     XI                  | -   Resist: 25 → 125    |
+-------------------------+-------------------------+
