...
::: {.column width="48.75%"}
-   Mother of the Earth <small>(Serius)</small>: 85 → 115
...
+---------------------------------------------------------------------+
| **Heletes' Boon\                                                    |
| **This personal quest directs you on how to craft your regalia once |
| you hit Lvl 30 *or* if you loaded a 1.39b6 player character with    |
| regalia equipped.                                                   |
+---------------------------------------------------------------------+
| **Heletes' Ingenuity\                                               |
| **This personal quest directs you on how to enhance your regalia    |
| for the first time once you hit Lvl 45 or higher with *at least*    |
| one Essence.                                                        |
+---------------------------------------------------------------------+
...
-   If **Sphinx** is reset during the *Vengeful Gaze* phase, it no
    ...
    retries
-   **Sphinx**'s *Vengeful Gaze* now defaults to target the front of her
...
-   **Sadism** <small>(Warlock)</small> now also checks whether lethal
    damage dealt by **Torment** to increment stacks

# Heroes

-   The majority of over time spell effects now apply their effects,
    e.g. damage or healing, every second. <small>(Previously, they
    applied at a much faster rate).</small>

## Assassin

***Assassinate***, ***Dancing Dagger***, ***Eviscerate*** and ***Walk in
the Shadows*** have received updated FX
...
-   Rewrote the description to state how much mana is drained per
    second, in addition to clarifying that the bonuses and base movement
    speed reduction only apply to the **Spartan Warrior** and other
    players' heroes in range
-   *AoE* nerfed to 450. <small>(Previously 500)</small>
-   *Base movement speed reduction* nerfed to 45% / 30%.
    <small>(Previously 20% / 20%)</small>
-   *Evasion* bonus nerfed to 25% / 30%. <small>(Previously 35% /
    40%)</small>
-   The M*agic Resistance* bonus of 35% / 40% is converted to a *Resist*
    bonus of 65 / 85
...
-   *Magic Resistance* bonus of 33% is converted to a *Resist* bonus of
...
-   Mana Regeneration---­Gain 10 / 15 / 20 / 25 / 30 / 35 / 40 / 45 / 50
    / 55 / 60 % increased Mana Regeneration.
...
Champion*** <small>(Armorsmith)</small>, and ***Plates of the
Ancient*****s** <small>(Champion's Armory)</small>

These items now have their "Ankh of Reincarnation" effect reclassified
as the *Auto-Life* item ability

***Ares' Bloodthristy Spear*** <small>(Master Metalsmith
Heletes)</small>
...
***Ring of Regret*** <small>(Midas)</small> and ***Midas' Band of
Vigor*** <small>(Metalsmith Galen)</small>
...
***Silenus' Talisma*****n** <small>(Midas)</small> and ***Midas' Pendant
of Wisdom*** <small>(Metalsmith Galen)</small>

The item ability to apply Enfeeble I is now formally written out as one,
alongside a few mechanical changes.

> Lower Resist---Spell effects have an 8% chance to Enfeeble I their
> target(s) for 8 seconds, which amplifies any magical damage dealt to
> them by 5%. If Lower Resist is applied by a spell-enhanced auto-attack
> or damage over time effect, Lower Resist cannot be applied on that
> target by either spell type for the next 12 seconds.

Notably, the chance to apply Lower Resist on a target is nerfed for
one-shot spell effects to 8%. However, all damage over time effects had
a significantly lower chance as they damaged units at a much faster rate
than 1 second. This change, coupled with the standardisation for all
damage over time spells, means that all spell effects that can apply
Lower Resist have an 8% chance to apply it for any type of spell.

## Resist Related Changes

***Lesser Ether Dust**, **Ether Dust**, **Greater Ether Dust**,* and
***Superior Ether Dust*** <small>(Goldsmith)</small>
...
***White Dragonscale Ring*****,** ***Green Dragonscale Ring***, and
***Red Dragonscale Ring*** <small>(Ladon)</small>

The *Magic Resistance* bonus of 15% is converted to a *Resist* bonus of
35

***White Dragonscale Ring of Addiction***, ***Green Dragonscale Ring of
Addiction***, and ***Red Dragonscale Ring of Addiction***
<small>(Metalsmith Zoticus)</small>

The *Magic Resistance* bonus of 20% is converted to a *Resist* bonus of
50

***Talisman of Serious Addiction*** and ***Warrior's Talisman of Serious
Addiction*** <small>(Champion's Armory)</small>

The *Magic Resistance* bonus of 25% is converted to a *Resist* bonus of
65

***Bright Silver Shinguards*** and ***Bright Silver Bracers***
<small>(Rare)</small>

The *Magic Resistance* bonus of 20% is converted to a *Resis*t bonus of
50

***Bright Silver Plates*** <small>(Metalsmith Galen)</small>

The *Magic Resistance* bonus of 30% is converted to a *Resist* bonus of
85

***Adamantium Helm*** <small>(Armorsmith)</small>

The *Magic Resistance* bonus of 35% is converted to a *Resist* bonus of
100
...
-   Now grants a *Resist* bonus of 25. <small>(Previously an active that
    grants a 10000 magic damage shield)</small>

***Shield of Zeus*** <small>(Goldsmith)</small>

-   No longer grants a *Health* bonus of 900
-   Now grants a *Resist* bonus of 25. <small>(Previously an active that
    grants a magic immunity shield).</small>

***Towering Shield of Athena*** <small>(Master Metalsmith
Heletes)</small>

-   Updated the typesetting of the tooltip and assigned item ability
    names for each non-standard bonus
-   The *Magic Resistance* bonus of 50% is converted to a *Resist* bonus
    of 175
-   *Towering Defense*, the auto-attack damage block, is nerfed to 50000
    damage. <small>(Previously 200000)</small>
...
+----------------------------------+-----------------------------------+
| **Tier I** <small>Lvl 30</small> | **Tier II** <small>Lvl 45</small> |
|                                  |                                   |
| Requires                         | Requires                          |
|                                  |                                   |
| -   Titan Fibre                  | -   Tier I                        |
| -   Titan Ore                    | -   5 Essence                     |
+----------------------------------+-----------------------------------+
| **Tier III** <small>Lvl          | **Tier IV** <small>Lvl 75</small> |
| 60</small>                       |                                   |
|                                  | Requires                          |
| Requires                         |                                   |
|                                  | -   Tier III                      |
| -   Tier II                      | -   125 Essence                   |
| -   25 Essence                   | -   2 Ruby Heart                  |
| -   2 Meteoric Iron              | -   2 Transport Stone             |
| -   2 Runestone                  |                                   |
+----------------------------------+-----------------------------------+
| **Tier V** <small>Lvl 90</small> | **Tier VI** <small>Lvl            |
|                                  | 105</small>                       |
| Requires                         |                                   |
|                                  | Requires                          |
| -   Tier IV                      |                                   |
| -   375 Essence                  | -   Tier V                        |
| -   2 Blood Ruby                 | -   750 Essence                   |
...
| -   2 Lump of Pure Adamantium    |                                   |
+----------------------------------+-----------------------------------+
| **Tier IX** <small>Lvl           | **Tier X** <small>Lvl 165</small> |
| 150</small>                      |                                   |
|                                  | Requires                          |
| Requires                         |                                   |
|                                  | -   Tier IX                       |
| -   Tier VIII                    | -   7500 Essence                  |
| -   5000 Essence                 | -   2 Blood Ruby                  |
| -   2 Blood Ruby                 | -   3 Stone of Heaven             |
| -   2 Stone of Heaven            |                                   |
+----------------------------------+-----------------------------------+
| **Tier XI** <small>Lvl           |                                   |
| 180</small>                      |                                   |
...
| -   Health: 150 → 3000          | -   Flat Mana Regen: 1 \> 3.5   |
| -   Mana: 15 → 165              | -   Attack Damage: 30 → 300     |
| -   Armor: 10 → 60              | -   Bloodthirsty                |
| -   Resist: 15 → 75             | -   Night Set---Lethal Poison's |
|                                 |     AGI Ratio set to 4.0 →      |
|                                 |     Lethal Poison's AGI Ratio   |
|                                 |     set to 8.0                  |
+---------------------------------+---------------------------------+
| **Shadows Regalia**             | **Light Regalia**               |
|                                 |                                 |
| -   Intelligence: 35 → 135      | -   Strength: 5 → 55            |
| -   Flat Health Regen: 1 → 17.5 | -   Intelligence: 30 → 80       |
| -   Spell Damage: 125 → 1375    | -   Spell Damage: 50 → 750      |
|                                 | -   Spell Healing: 150 → 2250   |
|                                 | -   Mana Regeneration I → Mana  |
|                                 |     Regeneration XI             |
+---------------------------------+---------------------------------+
...
| -   Spell Damage: 125 → 1375    | -   Mana: 150 → 1500            |
| -   Mana Regeneration I → Mana  | -   Spell Damage: 50 → 550      |
|     Regeneration XI             | -   Armor: 5 → 35               |
|                                 | -   Resist: 25 → 125            |
+---------------------------------+---------------------------------+
...
***Thundering Hammer of Zeus*** <small>(Master Metalsmith
Heletes)</small>
...
-   ***Lich*** and ***Cursed Weapon*** <small>(The Fools'
    Mausoleum)</small> now play their decay animation after being slain
...
-   Adjusted the arena for ***Goretusk*****'s** <small>(Tribal
    Village)</small> boss fight
-   ***Pelias**'* <small>(Southern Highlands)</small> drops changed to
    the following now that set items for each class have been removed:
    -   *High Oracle's Staff*; *High Oracle's Robes*; *Ring of Power*;
        and *Talisman of Wisdom*
-   ***Neleus**'* <small>(Southern Highlands)</small> drops changed to
    the following now that set items for each class have been removed:
    -   *Spartan Long Sword*; *Spartan Plate Mail*; *Ring of Might*;and
        *Amulet of Protection*
-   ***Hallowed One*****'s** <small>(Minotaur Burrows)</small> *Minotaur
    Warlock* adds now have an acquisition range of 1500.
    <small>(Previously 1000)</small>
-   Updated the code that runs when you engage ***Hallowed One***
    <small>(Minotaur Burrows)</small>, ***Midas*** <small>(The Fools'
    Mausoleum)</small>, ***Manslayer*** <small>(Minotaur
    Burrows)</small> and ***Lightbane*** <small>(Minotaur
    Burrows)</small>. This changes the acquisition range to 1500 units
    <small>(from 1000 units)</small> and now issues an attack-move order
    to the source of the damage *if* engagement occurs because of player
    characters
...
***Sphinx*** now has contribution checkpoints. If the fight finishes and
you meet two of these checkpoints, you'll receive the crafting materials
and ***Book of Skill Increase, Level 7*** rewards even if you're not in
proximity of ***Sphinx***.
...
Bosses that deal magical damage in the form of a spell or mechanic now
are nerfed because of the *Armor Type* and *Resist* changes to playable
characters.
...
::: columns
::: {.column style="padding-left: 0.5em; padding-right: 0.5em;"}
***Thea*** <small>(Northern Trail)</small>\
• *Retaliation Entangling Roots* mechanic nerfed to 150 damage per tick
<small>(from 220)</small>

***Hallowed*** ***One*** <small>(Minotaur Burrows)</small>\
• *Charge* damage reduced to 1875 <small>(from 2500)</small>

***Manslayer*** <small>(Minotaur Burrows)</small>\
• *Deafening Bellow* damage reduced to 1875 <small>(from 2500)</small>

***Cyclops*** <small>(Eastern Highlands)</small>\
• *Hurl Boulder* damage nerfed to 1500 <small>(from 2000)</small>

***Cronus*** <small>(Barbaric Plains)</small>\
• *Death Coil* damage nerfed to 1500 <small>(from 2000)</small>

***Gaea*** (Base Form) <small>(Eastern Highlands)</small>\
• *Thunder Bolt* mechanic nerfed to 1625 damage <small>(from
2000)</small> and 812.5 AoE damage to all targets <small>(from
1000)</small>

***Shadowslayer*** <small>(Isle of Issus)</small>\
• *Poison Sting* mechanic nerfed to 300 damage per tick <small>(from
500)</small>

***Hydra*** <small>(Eretria)</small>\
• *Breath of Fire* initial damage nerfed to 1625 <small>(from
2000)</small>\
• *Drunken Haze* bonus DoT damage nerfed to 243.75 per tick
<small></small>(from 300)</small>\
• *Shadow Strike* initial damage nerfed to 812.5 <small>(from
1000)</small> and DoT damage nerfed to 406.25 per tick <small>(from
500)</small>
:::

::: {.column style="padding-left: 0.5em; padding-right: 0.5em;"}
***Helios*** <small>(Corinth)</small>\
• *Fire Blast* mechanic nerfed to deal 2000 damage per tick <small>(from
2500)</small>

***Selene*** <small>(Corinth)</small>\
• *Meteor Shower* mechanic nerfed to deal 24375 damage <small>(from
30000)</small> and now deals physical damage <small>(instead of magical
damage)</small>

***Theia*** <small>(Corinth)</small>\
• *Frost Nova* nerfed to deal 8125 damage <small>(from 10000)</small>

***Eos*** <small>(Corinth)</small>\
• *Chain Lightning* nerfed to deal 6000 initial damage <small>(from
7500)</small>

***Hyperion*** <small>(Corinth)</small>\
• The *Nova* mechanic nerfed to deal 20000 × (550 − ***d***) / 450
damage, where ***d*** is the distance from the centre of the nova to the
enumerated unit <small>(from 25000 × (550 − ***d***) / 450)</small>\
• The *Thunder Bolt* mechanic damage nerfed to 9750 damage <small>(from
12000)</small>
:::
:::
...
::: columns
::: {.column style="padding-left: 0.5em; padding-right: 0.5em;"}
***Nukacha*** <small>(Incursion Point)</small>\
• *Chain Lightning* initial damage nerfed to 93.75 <small>(from
125)</small>

***Rokthul*** <small>(Northern Trail)</small>\
• *Chain Lightning* initial damage nerfed to 375 <small>(from
500)</small>

***Forest Terror*** <small>(Infested Woods)</small>\
• *Shadow Strike* damage nerfed to 130 <small>(from 175)</small> and DoT
nerfed to 100 per tick <small>(from 175)</small>

***Goretusk*** <small>(Tribal Village)</small>\
• *Furious Charge* nerfed to 1400 magical damage <small>(from
2500)</small>\
• *Spike Barrage* nerfed to 1125 magical damage <small>(from
2000)</small>

***Gethos*** <small>(Corinth)</small>\
• *Storm Bolt* damage nerfed to 375.5 <small>(from 500)</small>\
• *Geyser* initial damage nerfed to 187.5 <small>(from 250)</small> and
follow-up damage nerfed to 450 <small>(from 600)</small>

***Lucas Farblaze*** <small>(Eastern Highlands)</small>\
• *Firebolt* damage nerfed to 1500 <small>(from 2000)</small>
:::

::: {.column style="padding-left: 0.5em; padding-right: 0.5em;"}
***Minotaur Warlock*** <small>(Minotaur Burrows)</small>\
• *Fireball* damage nerfed to 1000 <small>(from 1333)</small>

***Hallowed Offspring*** <small>(Minotaur Burrows)</small>\
• *Charge* damage reduced to 1875 <small>(from 2500)</small>

***Soulless*** <small>(Southern Highlands)</small>\
• *Frost Bolt* damage nerfed to 300 <small>(from 400)</small>

***Tormenter*** <small>(The Black Road)</small>\
• *Chain Lightning* damage nerfed to 262.5 <small>(from 350)</small>

***Ice Giant*** <small>(The Frozen Citadel)</small>\
• *Ice Ring* damage nerfed to 3250 <small>(from 4000)</small>
:::
:::
:::
