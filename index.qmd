...
-   Adding the `-craftkey`/`-ck` chat command. This changes the crafting
    ...
    system will remember your setting for it at a character-level.
...
>     0.7 / 0.8 / 0.9 / 1.0 Spell Damage) physical damage to enemies
>     over 4 seconds. Whenever an enemy enters *Wall of Roots* for the
>     first time: They are Ensnared, which prevents their movement for 2
>     seconds.
>
> -   Cooldown: 10 seconds.
>
...
>     / 0.05 / 0.0625 / 0.075 / 0.0875 / 0.1 Spell Healing) health and
>     1.75% Maximum Mana is drained from the *Druid*. *Soothing
>     Presence* deactivates if sufficient mana cannot be drained.
>
> -   Cooldown: 10 seconds.
>
> **Aspect of the Dryad**
...
>     *Soothing Presence*: Restore 5% missing mana to allies within a
>     450 AoE
>
> **Storm Form**
>
> -   Transform the Druid into a Storm Elemental that has the following
>     traits:
>
...
>
>     -   Access to *Preordain Lightning*, *Thunderbolt*, *Maelstrom*,
>         and *Aspect of the Nereid*.
>
> -   Cooldown: 10 seconds.
>
> **Preordain Lightning**
...
>
> -   Blasts out a bolt thunder towards target location, dealing 100 /
>     175 / 350 / 700 / 1250 / 2500 / 3750 / 5000 (+0.8 / 0.9 / 1.0 /
>     1.1 / 1.2 / 1.3 / 1.4 / 1.5 Spell Damage) magical damage to
>     enemies in a line and reduces their armor by 10 / 15 / 20 / 25 /
>     30 / 35 / 40 / 45 for 8 seconds.
>
> -   Cooldown: 13 seconds.
>
> **Maelstrom**
...
>     *Maelstrom*: Your auto-attack cooldown becomes 1 second
>     (previously 2.5 seconds). Lasts for 3 seconds.
>
> **Human Form**
>
> -   Transform the Druid into a Human that has the following traits:
>
>     -   Attack type changes to Magical.
>
>     -   Armor type changes to Medium.
>
>     -   Access to *Rejuvenation*, *Wall of Roots*, *Soothing
>         Presence*, and *Aspect of the Dryad*.
>
> -   Cooldown: 10 seconds.
-->
### Ranger
...
> mana per second. **Warrior class allies have their mana regeneration
> increased by 1 mana per second instead.**
>
> -   Affects *Hera's Blessing*

-   Brilliance Aura II

> Allies within a 450 AoE have their mana regeneration increased by 15
> mana per second. **Warrior class allies have their mana regeneration
> increased by 3 mana per second instead.**
>
> -   Affects *Scepter of the Chosen Ones*

-   *Hera's Cure I* and *Hera's Cure II*

> -   It can no longer be activated at full health
>
