...
# forging.lines[136:597] |> head(n = 10)
...
item.cleaned.df |>
  ...
  mutate(vendor = paste0("<div><div>", if_else(!is.na(vendor), vendor, ""), "</div>", if_else(!is.na(reg.present.div), reg.present.div, ""), if_else(!is.na(present.div), present.div, ""), "</div>") ,
         present.div = NULL) |>
