...
1. Hero information, including: 
    - Hero's class and level
    - Profession and profession level
    - Base stats
    - Equipped items
    - Familiar skills
    - Active buffs
2. DPS calculations for Total, Physical, and Magical DPS
    - The calculation for DPS uses an average (mean) updated every second
    - The total damage and duration is reported
    - The minimum and maximum damage numbers for physical and magical damage are also reported
3. The ability adjust the armor, magic resist, and armor type of the *Sedah Scarecrow*
4. The ability to adjust how the DPS feedback's timer works
    - Infinite timer and the DPS feedback tracks like Wc3's buff bar
    - A fixed timer, either 30s, 60s, or 180s, and the DPS feedback "memorises" the buffs you use throughout the duration
    - (Changing the timer will reset the DPS feedback)
5. The ability to configure the Sedah Scarecrow to either *Hades*, *Hyperion*, or *No Resistances* durabilities
6. Features a *Close* and *Reset Timer* button

The DPS feedback tracks only tracks the damage you have dealt to it. Also, the feedback does not start timing until it takes damage from you. Lastly, the user interface automatically closes if you are no longer within 1000 units of it.
...
- Polished the tooltips for *Dispatch* (Spartan Warrior), *Throw Javelin* (Spartan Warrior), *Charge* (Spartan Warrior), *Cataclysm* (Guardian of Nature), *Tremor* (Guardian of Nature), and *Impale* (Warlord).
